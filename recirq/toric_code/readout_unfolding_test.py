...
class TestReadoutUnfolder:
    @pytest.mark.parametrize("use_uniform_prior", [False, True])
    @pytest.mark.parametrize("distribution", DISTRIBUTIONS)
    def test_initial_guess(self, use_uniform_prior, distribution):
    ...
    @pytest.mark.parametrize("use_uniform_prior", [False, True])
    @pytest.mark.parametrize("distribution", DISTRIBUTIONS)
    def test_correct_with_identity_matrix(self, use_uniform_prior, distribution):
        unfolder = ru.ReadoutUnfolder(use_uniform_prior=use_uniform_prior)
    ...
    def test_error_on_one_qubit(self, use_uniform_prior, ideal):
        unfolder = ru.ReadoutUnfolder(use_uniform_prior=use_uniform_prior)
    ...
    @pytest.mark.parametrize("use_uniform_prior", [False, True])
    @pytest.mark.parametrize("ideal", DISTRIBUTIONS)
    def test_correlated_error(self, use_uniform_prior, ideal):
        unfolder = ru.ReadoutUnfolder(use_uniform_prior=use_uniform_prior)
        ideal = np.array(ideal)
        readout_matrix = np.array(
            [
