from qc_afqmc.quaff import indexing, json_serialization, linalg, random, testing
...
def _register_resolver() -> None:
    from qc_afqmc.quaff.json_resolver import json_resolver
    from qc_afqmc.quaff.json_serialization import _internal_register_resolver
