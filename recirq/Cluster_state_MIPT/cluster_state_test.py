...
class ClusterStateTest(unittest.TestCase):
    ...
    def test_get_circuit_basis_rotations(self):
        ...
        self.assertTrue(any(isinstance(op.gate, cirq.H) for op in circuit_x.all_operations()))
        ...
        self.assertFalse(any(isinstance(op.gate, (cirq.H, cirq.Rx)) for op in circuit_z.all_operations()))
    ...
    def test_get_circuit_ancilla_operations(self):
        ...
        self.assertTrue(any(isinstance(op.gate, cirq.H) and op.qubits[0] in ancilla_qubits
